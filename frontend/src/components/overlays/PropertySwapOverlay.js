...
const PropertySwapOverlay = ({ animation, onComplete, user }) => {
  ...
  const colorStyle = colorMap[property1.color] || { bg: '#4A5568', text: '#FFFFFF', gradient: ['#4A5568DD', '#5A6678DD', '#6B7888DD'] };
  ...
  const property1WithDefaults = {
    ...
    rent: property1.rent || [1],
    isWild: property1.isWild || false,
    isUtility: property1.isUtility || false,
    isRailroad: property1.isRailroad || false,
    width: 160,
    height: 220,
    ...property1
  };
